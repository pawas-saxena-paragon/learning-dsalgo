...
describe("#binary search", () => {
  ...
  it("Binary search nums = [1,2,3,4,5], target = 25", () => {
    expect(binarySearch([1, 2, 3, 4, 5], 25, 0, 5)).toEqual(-1);
  });
...
describe("#getrotationPivot", () => {
  it("#getRotationPivot nums = [4,5,6,7,0,1,2]", () => {
    expect(getRotationPivot([4, 5, 6, 7, 0, 1, 2])).toEqual(4);
  });

  it("#getRotationPivot nums = [1,2,4,5,6,7,0]", () => {
    expect(getRotationPivot([1, 2, 4, 5, 6, 7, 0])).toEqual(6);
  });

  it("#getRotationPivot nums = [0,1,2,4,5,6,7]", () => {
    expect(getRotationPivot([0, 1, 2, 4, 5, 6, 7])).toEqual(-1);
  });

  it("#getRotationPivot nums = [7,0,1,2,4,5,6]", () => {
    expect(getRotationPivot([7, 0, 1, 2, 4, 5, 6])).toEqual(1);
  });
});
